...
_ENV_OVERRIDES = {
    ...
    "TRADINGAGENTS_MARKET_ANALYST_LLM_PROVIDER": "market_analyst_llm_provider",
    "TRADINGAGENTS_MARKET_ANALYST_LLM_MODEL":    "market_analyst_llm_model",
    "TRADINGAGENTS_MARKET_ANALYST_BACKEND_URL":  "market_analyst_backend_url",
